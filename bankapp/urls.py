...
urlpatterns = [
    ...
    path('transfers/<int:transfer_id>/receipt/', views.TransferReceiptView.as_view(), name='transfer-receipt'),
    path('transfers/<int:transfer_id>/receipt/pdf/', views.TransferReceiptPDFView.as_view(), name='transfer-receipt-pdf'),
    path('transfers/<int:transfer_id>/receipt/image/', views.TransferReceiptImageView.as_view(), name='transfer-receipt-image'),
